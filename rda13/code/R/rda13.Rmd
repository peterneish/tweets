---
title: "Twitter coverage of the 2019 RDA Plenary"
author: "Peter Neish"
date: "`r Sys.time()`"
output: 
  html_document: 
...
hashtag <- c("#rdaplenary", "#rdaplenary13")
conf_name <- "RDA 13 Plenary"
timezone <- "EST5EDT"
days <- c("2019-04-01", "2019-04-02", "2019-04-03", "2019-04-04")
accent <- "skyblue3"
pal <- "Set1"
topics_k <- 6
...
collected using the `rtweet` R package. Code comes from [Luke Zappia](https://github.com/lazappi/twitter-stats)
...
`r tweets_media[1, "screen_name"]`
![](`r tweets_media[1, "media_url"]`)
`r tweets_media[2, "screen_name"]`
![](`r tweets_media[2, "media_url"]`)
`r tweets_media[3, "screen_name"]`
![](`r tweets_media[3, "media_url"]`)
`r tweets_media[4, "screen_name"]`
![](`r tweets_media[4, "media_url"]`)
`r tweets_media[5, "screen_name"]`
![](`r tweets_media[5, "media_url"]`)
